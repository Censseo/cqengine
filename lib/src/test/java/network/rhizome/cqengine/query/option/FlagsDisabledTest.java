...
import static network.rhizome.cqengine.query.QueryFactory.disableFlags;
import static network.rhizome.cqengine.query.QueryFactory.queryOptions;
import static network.rhizome.cqengine.query.option.FlagsDisabled.isFlagDisabled;
