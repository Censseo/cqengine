 ...
 */
package network.rhizome.cqengine.attribute.support;
...
import network.rhizome.cqengine.attribute.support.AbstractAttribute;
...
public class AbstractAttributeTest {
    ...
    public void testConstructors() {
        ...
        Assert.assertEquals("<Unnamed attribute, class network.rhizome.cqengine.attribute.support.AbstractAttributeTest$ValidAttributeMultipleConstructors>", a1.getAttributeName());
        Assert.assertEquals("foo", a2.getAttributeName());
        Assert.assertEquals("<Unnamed attribute, class network.rhizome.cqengine.attribute.support.AbstractAttributeTest$ValidAttributeMultipleConstructors>", a3.getAttributeName());
