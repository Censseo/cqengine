...
import network.rhizome.cqengine.index.sqlite.SQLiteIndex;
import network.rhizome.cqengine.index.sqlite.support.DBQueries;
import network.rhizome.cqengine.index.support.CloseableIterable;
import network.rhizome.cqengine.index.support.KeyStatistics;
import network.rhizome.cqengine.index.support.KeyValue;
...
import network.rhizome.cqengine.query.simple.FilterQuery;
...
import static network.rhizome.cqengine.testutil.TestUtil.setOf;
