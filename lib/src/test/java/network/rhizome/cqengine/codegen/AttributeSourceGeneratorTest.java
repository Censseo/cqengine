...
import static network.rhizome.cqengine.codegen.AttributeSourceGenerator.generateAttributesForPastingIntoTargetClass;
import static network.rhizome.cqengine.codegen.AttributeSourceGenerator.generateSeparateAttributesClass;
...
public class AttributeSourceGeneratorTest {
    ...
    public void testGenerateSeparateAttributesClass() {
        String expected = "" +
                ...
                "import java.util.*;\n" +
                "import network.rhizome.cqengine.codegen.AttributeSourceGeneratorTest.Car;\n" +
                "\n" +
                "/**\n" +
                " * CQEngine attributes for accessing the members of class {@code network.rhizome.cqengine.codegen.AttributeSourceGeneratorTest.Car}.\n" +
                " * <p/>.\n" +
