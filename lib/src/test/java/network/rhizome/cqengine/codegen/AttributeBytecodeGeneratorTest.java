...
import network.rhizome.cqengine.examples.inheritance.SportsCar;

import network.rhizome.cqengine.attribute.*;
import network.rhizome.cqengine.codegen.AttributeBytecodeGenerator;
import network.rhizome.cqengine.codegen.AttributeNameProducers;
import network.rhizome.cqengine.codegen.MemberFilters;
...
import static network.rhizome.cqengine.codegen.AttributeBytecodeGenerator.*;
