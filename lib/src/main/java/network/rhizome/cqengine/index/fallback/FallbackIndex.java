 ...
 */
package network.rhizome.cqengine.index.fallback;
...
import network.rhizome.cqengine.query.simple.All;
import network.rhizome.cqengine.query.simple.None;
 ...
 * {@link Query#matches(Object, network.rhizome.cqengine.query.option.QueryOptions)}.
 * <p/>
...
public class FallbackIndex<O> implements Index<O> {
     ...
     * {@link Index#retrieve(network.rhizome.cqengine.query.Query, network.rhizome.cqengine.query.option.QueryOptions)} method can subsequently iterate.</b>
     */
    @Override
