 ...
 * {@link network.rhizome.cqengine.index.compound.CompoundIndex}, which groups several other attributes.
 * <p/>
 * Note that, being like regular {@link network.rhizome.cqengine.attribute.Attribute}s, objects of this type
 * do not represent values but rather the means to obtain values from fields in an object. <i>Values</i> for compound
 * attributes are encapsulated separately in {@link CompoundValueTuple} objects. The {@link Attribute#getValues(Object, network.rhizome.cqengine.query.option.QueryOptions)} method
 ...
 * {@code CompoundAttribute} groups only {@link network.rhizome.cqengine.attribute.SimpleAttribute}s, or whether it
 * groups any {@link network.rhizome.cqengine.attribute.MultiValueAttribute}s.
 * <ul>
 *     <li>
 *         <b>Generating tuples for a group of {@code SimpleAttribute}s</b><br/>
 *         If a compound attribute groups only {@link network.rhizome.cqengine.attribute.SimpleAttribute}s, then the list
 ...
 *         If a compound attribute groups one or more {@link network.rhizome.cqengine.attribute.MultiValueAttribute}s,
 ...
 *         {@link Attribute#getValues(Object, network.rhizome.cqengine.query.option.QueryOptions)} method will retrieve a list of values from the object for each of the component
 ...
 *         The {@link Attribute#getValues(Object, network.rhizome.cqengine.query.option.QueryOptions)} method would then return these tuples as a list of {@link CompoundValueTuple}
 *         objects
 *     </li>
 * </ul>
 *
...
public class CompoundAttribute<O> implements Attribute<O, CompoundValueTuple<O>> {
     ...
     *
     * @param object The object from which all {@link network.rhizome.cqengine.index.compound.support.CompoundValueTuple}s are required
     * @param queryOptions
