 ...
 */
package network.rhizome.cqengine.query.parser.common;
...
public class ParseResult<O> {
    ...
    /**
     * Returns the parsed query options, which may include {@link network.rhizome.cqengine.query.option.OrderByOption}
