 ...
 */
package network.rhizome.cqengine.query.parser.sql.support;
...
/**
 * A variant of {@link network.rhizome.cqengine.query.parser.cqn.support.DateMathParser} which can be used with
 * the SQL dialect.
 *
 * @author npgall
 */
public class DateMathParser extends network.rhizome.cqengine.query.parser.cqn.support.DateMathParser {
