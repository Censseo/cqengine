...
import network.rhizome.cqengine.attribute.support.*;
import network.rhizome.cqengine.entity.MapEntity;
import network.rhizome.cqengine.entity.PrimaryKeyedMapEntity;
...
public class QueryFactory {
     ...
     * {@link #orderBy(network.rhizome.cqengine.query.option.AttributeOrder[])} method to create a query option which
    ...
    /**
     * A convenience method to encapsulate several objects together as {@link network.rhizome.cqengine.query.option.QueryOptions},
    ...
    /**
     * A convenience method to encapsulate a collection of objects as {@link network.rhizome.cqengine.query.option.QueryOptions},
     * where the class of the object will become its key in the QueryOptions map.
     *
     * @param queryOptions The objects to encapsulate as QueryOptions
     * @return A {@link QueryOptions} object
     ...
     * {@link network.rhizome.cqengine.query.option.QueryOptions}.
     *
     * @return A {@link QueryOptions} object
     */
    ...
    /**
     * Overloaded variant of {@link #orderBy(network.rhizome.cqengine.query.option.AttributeOrder[])} - see that method
     * for details.
     * <p/>
     * Note: This method is unnecessary as of Java 7, and is provided only for backward compatibility with Java 6 and
     * earlier, to eliminate generic array creation warnings output by the compiler in those versions.
