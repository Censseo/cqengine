 ...
 * {@link #isValid(Object, network.rhizome.cqengine.query.option.QueryOptions)} method. If this method returns true, this iterator returns the object, if it returns false
