...
import network.rhizome.cqengine.resultset.common.NoSuchObjectException;
import network.rhizome.cqengine.resultset.common.NonUniqueObjectException;
...
public abstract class ResultSet<O> implements Iterable<O>, Closeable {
     ...
     * queries are supplied and are connected using a simple {@link network.rhizome.cqengine.query.logical.Or}
