 ...
 */
package network.rhizome.cqengine.codegen;

import java.lang.reflect.*;
import java.util.*;

import static network.rhizome.cqengine.codegen.MemberFilters.ALL_MEMBERS;
import static network.rhizome.cqengine.codegen.MemberFilters.FIELDS_ONLY;
 ...
 * <p/>
 * Generates CQEngine {@link network.rhizome.cqengine.attribute.SimpleAttribute}s or
 * {@link network.rhizome.cqengine.attribute.SimpleNullableAttribute}s for members which return singular values,
 * and generates CQEngine {@link network.rhizome.cqengine.attribute.MultiValueNullableAttribute}s for members
...
public class AttributeSourceGenerator {
    ...
    static String generateAttributesForClass(final Class<?> targetClass, boolean separateAttributesClass, String packageOfAttributesClass, MemberFilter memberFilter) {
        ...
        if (separateAttributesClass) {
            ...
            sb.append("import network.rhizome.cqengine.attribute.*;\n");
            sb.append("import network.rhizome.cqengine.query.option.QueryOptions;\n");
