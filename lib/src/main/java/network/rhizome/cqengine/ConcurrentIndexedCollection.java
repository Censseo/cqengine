...
import network.rhizome.cqengine.engine.QueryEngineInternal;
import network.rhizome.cqengine.engine.CollectionQueryEngine;
import network.rhizome.cqengine.index.Index;
import network.rhizome.cqengine.index.support.CloseableIterator;
import network.rhizome.cqengine.index.support.CloseableRequestResources;
import network.rhizome.cqengine.metadata.MetadataEngine;
...
import network.rhizome.cqengine.persistence.support.ObjectStoreAsSet;
import network.rhizome.cqengine.persistence.support.PersistenceFlags;
...
/**
 * An implementation of {@link java.util.Set} and {@link network.rhizome.cqengine.engine.QueryEngine}, thus providing
 * {@link #retrieve(network.rhizome.cqengine.query.Query)} methods for performing queries on the collection to retrieve
 * matching objects, and {@link #addIndex(network.rhizome.cqengine.index.Index)} methods allowing indexes to be
