...
import network.rhizome.cqengine.query.option.ArgumentValidationOption;
...
import network.rhizome.cqengine.resultset.closeable.CloseableFilteringResultSet;
...
import static network.rhizome.cqengine.query.option.IsolationLevel.READ_UNCOMMITTED;
import static network.rhizome.cqengine.query.option.IsolationOption.isIsolationLevel;
 ...
 * @see #update(Iterable, Iterable, network.rhizome.cqengine.query.option.QueryOptions)
 *
...
public class TransactionalIndexedCollection<O> extends ConcurrentIndexedCollection<O> {
     ...
     * {@link #update(Iterable, Iterable, network.rhizome.cqengine.query.option.QueryOptions)}.
     * <p/>
     * @see #update(Iterable, Iterable, network.rhizome.cqengine.query.option.QueryOptions)
     */
    @Override
     ...
     * supplying an {@link network.rhizome.cqengine.query.option.IsolationOption} query option to this method requesting
     * {@link network.rhizome.cqengine.query.option.IsolationLevel#READ_UNCOMMITTED} transaction isolation instead.
