...
import network.rhizome.cqengine.engine.QueryEngine;
 ...
 * <p/>
 * The {@link #retrieve(network.rhizome.cqengine.query.Query)} methods accept a {@link network.rhizome.cqengine.query.Query}
 * and return a {@link network.rhizome.cqengine.resultset.ResultSet} of objects matching that query.
 * <p/>
 * The {@link #addIndex(network.rhizome.cqengine.index.Index)} methods allowing indexes to be added to the collection to
...
public interface IndexedCollection<O> extends Set<O>, QueryEngine<O> {
     ...
     *         {@link network.rhizome.cqengine.index.sqlite.support.SQLiteIndexFlags#BULK_IMPORT}.
     *         </li></ul>
     *     </li>
     * </ul>
     *
