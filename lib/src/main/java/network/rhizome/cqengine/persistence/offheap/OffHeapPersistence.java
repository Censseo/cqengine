...
import network.rhizome.cqengine.index.sqlite.RequestScopeConnectionManager;
import network.rhizome.cqengine.index.sqlite.SQLitePersistence;
...
import network.rhizome.cqengine.persistence.support.sqlite.LockReleasingConnection;
import network.rhizome.cqengine.persistence.support.sqlite.SQLiteObjectStore;
import network.rhizome.cqengine.persistence.support.sqlite.SQLiteOffHeapIdentityIndex;
...
import static network.rhizome.cqengine.persistence.support.PersistenceFlags.READ_REQUEST;
 ...
 * {@link network.rhizome.cqengine.IndexedCollection} and multiple indexes all persist to the same area of memory,
 ...
 * {@link network.rhizome.cqengine.IndexedCollection} or indexes using this object for persistence (which hold a
