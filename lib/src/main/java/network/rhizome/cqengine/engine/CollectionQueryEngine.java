 ...
 */
package network.rhizome.cqengine.engine;
...
import network.rhizome.cqengine.index.sqlite.IdentityAttributeIndex;
import network.rhizome.cqengine.index.sqlite.SQLiteIdentityIndex;
import network.rhizome.cqengine.index.sqlite.SimplifiedSQLiteIndex;
import network.rhizome.cqengine.index.support.*;
import network.rhizome.cqengine.index.compound.CompoundIndex;
import network.rhizome.cqengine.index.compound.support.CompoundAttribute;
import network.rhizome.cqengine.index.compound.support.CompoundQuery;
import network.rhizome.cqengine.index.fallback.FallbackIndex;
import network.rhizome.cqengine.index.standingquery.StandingQueryIndex;
import network.rhizome.cqengine.index.unique.UniqueIndex;
import network.rhizome.cqengine.persistence.Persistence;
import network.rhizome.cqengine.persistence.support.ObjectSet;
import network.rhizome.cqengine.persistence.support.ObjectStore;
import network.rhizome.cqengine.persistence.support.ObjectStoreResultSet;
import network.rhizome.cqengine.persistence.support.sqlite.SQLiteObjectStore;
import network.rhizome.cqengine.query.ComparativeQuery;
...
import network.rhizome.cqengine.query.option.*;
import network.rhizome.cqengine.query.simple.*;
import network.rhizome.cqengine.resultset.ResultSet;
import network.rhizome.cqengine.resultset.closeable.CloseableResultSet;
import network.rhizome.cqengine.resultset.common.CostCachingResultSet;
import network.rhizome.cqengine.resultset.connective.ResultSetDifference;
import network.rhizome.cqengine.resultset.connective.ResultSetIntersection;
import network.rhizome.cqengine.resultset.connective.ResultSetUnion;
import network.rhizome.cqengine.resultset.connective.ResultSetUnionAll;
import network.rhizome.cqengine.resultset.filter.MaterializedDeduplicatedIterator;
import network.rhizome.cqengine.resultset.filter.FilteringIterator;
import network.rhizome.cqengine.resultset.filter.FilteringResultSet;
import network.rhizome.cqengine.resultset.iterator.ConcatenatingIterable;
import network.rhizome.cqengine.resultset.iterator.ConcatenatingIterator;
import network.rhizome.cqengine.resultset.iterator.IteratorUtil;
import network.rhizome.cqengine.resultset.iterator.UnmodifiableIterator;
import network.rhizome.cqengine.resultset.order.AttributeOrdersComparator;
import network.rhizome.cqengine.resultset.order.MaterializedDeduplicatedResultSet;
import network.rhizome.cqengine.resultset.order.MaterializedOrderedResultSet;
import network.rhizome.cqengine.index.support.CloseableRequestResources.CloseableResourceGroup;
...
import static network.rhizome.cqengine.query.option.EngineFlags.INDEX_ORDERING_ALLOW_FAST_ORDERING_OF_MULTI_VALUED_ATTRIBUTES;
import static network.rhizome.cqengine.query.option.EngineFlags.PREFER_INDEX_MERGE_STRATEGY;
import static network.rhizome.cqengine.query.option.FlagsEnabled.isFlagEnabled;
import static network.rhizome.cqengine.resultset.iterator.IteratorUtil.concatenate;
import static network.rhizome.cqengine.resultset.iterator.IteratorUtil.groupAndSort;
