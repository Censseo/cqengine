...
public interface QueryEngine<O> {
     ...
     * <p/>
     * Subsequently queries passed to the {@link #retrieve(network.rhizome.cqengine.query.Query, QueryOptions)} method
     ...
     * {@link #addIndex(network.rhizome.cqengine.index.Index, QueryOptions)} method.
     *
